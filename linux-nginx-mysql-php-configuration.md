...
|Domain| document root|
|---|---|
|dodo-found.tk|/var/www/fourtimes|
...
|users| document root|
|---|---|
|fourtimes|/var/www/fourtimes|
|dodofound|/var/www/dodofound|
...
sudo mkdir -p /var/www/fourtimes.ml
sudo chown -R fourtimes:fourtimes /var/www/fourtimes.ml
sudo "local_root=/var/www/fourtimes.ml" | tee  /etc/vsftpd/users/fourtimes
...
**Note:**  If the /home directory does not appear, check your user shell type, delete your user, then create a new user with the `adduser` command.
